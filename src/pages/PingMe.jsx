...
const features = [
  ...
  },
  {
    ...
    description:
      "View and manage all your active reminders in one place. Each reminder shows its linked location, trigger condition, and status — keeping you organised at a glance.",
    image: img3,
    ...
    <div className="min-h-screen bg-orange-50">
      ...
      >
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-6">
          ...
          <div className="w-20 h-20 rounded-2xl bg-orange-200 border-2 border-dashed border-orange-400 flex items-center justify-center text-orange-400 text-3xl flex-shrink-0">
            {/* Replace this div with: <img src={appLogoImg} className="w-20 h-20 rounded-2xl object-cover" /> */}
            📍
          </div>
          <div>
            <h1
